...
func TestListPeopleWritesList(t *testing.T) {
	buf := new(bytes.Buffer)
	in := protobuf.AddressBook{People: []*protobuf.Person{
		{
			Name:  "John Doe",
			Id:    101,
		...
		},
		{
			...
			Phones: []*protobuf.Person_PhoneNumber{
				{Number: "555-555-5555", Type: protobuf.Person_WORK},
			},
		},
		{
			Name:  "Jack Buck",
			...
			Phones: []*protobuf.Person_PhoneNumber{
				{Number: "555-555-0000", Type: protobuf.Person_HOME},
				{Number: "555-555-0001", Type: protobuf.Person_MOBILE},
				{Number: "555-555-0002", Type: protobuf.Person_WORK},
			},
		},
		{
			Name:  "Janet Doe",
			...
			Phones: []*protobuf.Person_PhoneNumber{
				{Number: "555-777-0000"},
				{Number: "555-777-0001", Type: protobuf.Person_HOME},
			},
		},
	}}
	listPeople(buf, &in)
