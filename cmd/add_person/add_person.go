...
func promptForAddress(r io.Reader) (*protobuf.Person, error) {
	...
	for {
		...
		pn := &protobuf.Person_PhoneNumber{
			Number: phone,
		}
		...
		switch ptype {
		case "mobile":
			pn.Type = protobuf.Person_MOBILE
		case "home":
			pn.Type = protobuf.Person_HOME
		case "work":
			pn.Type = protobuf.Person_WORK
		default:
