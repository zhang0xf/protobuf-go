...
`
	...
	want := []*protobuf.Person_PhoneNumber{
		{Number: "123-456-7890", Type: protobuf.Person_HOME},
		{Number: "222-222-2222", Type: protobuf.Person_MOBILE},
		{Number: "111-111-1111", Type: protobuf.Person_WORK},
		{Number: "777-777-7777", Type: protobuf.Person_MOBILE},
	}
